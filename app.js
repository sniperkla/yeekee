...
app.get("/yeekee", async (req, res) => {
  ...
  for (let i = 1; i <= 88; i++) {
    round.push(
      `div#huayYeekee-section div:nth-child(${i}) > div > div.p-1.mb-1.huay-card-header > span.huay-card-product.huay-card-product-yeekee.ml-2 > span.huay-card-period-yk`
    );
    upper3.push(
      `div#huayYeekee-section div:nth-child(${i}) > div > div.p-0.huay-card-body > div > div.text-center.w-50.huay-card-border-right.m-0 > div.p-0.text-award-choke`
    );
    lower2.push(
      `div#huayYeekee-section div:nth-child(${i}) > div > div.p-0.huay-card-body > div > div:nth-child(2) > div.p-0.text-award-choke`
    );
  }
